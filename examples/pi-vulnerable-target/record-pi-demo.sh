...
usage() {
  printf '%s\n' "usage: $0 [--asset PATH] [--out DIR] --pi-host HOST --fixture-ip IP --control-url URL --client-a IP --client-b IP --client-ssh-user USER --wan-forbidden-ip IP --upstream-interface IFACE --updated-config PATH --until RFC3339 [--max-seconds N] [--ollama-check load|refuse] [--readonly-root]"
}
