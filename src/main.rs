    ...
    // IMPLEMENT
        // -- add entire portion of code for the project management portion, where each new project
        // creates a .kelp-project folder, and projects are stored inside in a new file directory.
        // give users the option to select which project they want after Rust program scans the
        // local file system for the .kelp-project folder. 
