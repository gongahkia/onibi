...
Options:
  --transport <mode>       lan, tailscale, tailscale-private, wireguard, zerotier, cloudflare-quick, cloudflare-named, or ngrok
...
valid_transport() {
  case "$1" in
    lan|tailscale|tailscale-private|wireguard|zerotier|cloudflare-quick|cloudflare-named|ngrok) return 0 ;;
    *) return 1 ;;
  esac
}
