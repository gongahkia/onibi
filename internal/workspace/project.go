...
func validateTransportMode(mode string) error {
	...
	case "lan", "tailscale", "tailscale-private", "wireguard", "zerotier", "cloudflare-quick", "cloudflare-named", "ngrok", "telegram", "matrix", "slack", "discord", "auto":
		return nil
	case "email", "sms", "apns", "gotify", "ntfy", "pushover", "signal", "irc", "zulip":
