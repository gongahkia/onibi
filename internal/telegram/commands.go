...
var commandSpecs = []CommandSpec{
	...
	{Name: "/new", Args: "[--headless|--visible] <agent|shell|tmux> [args...]", Short: "start a headless or visible session", Detail: "Starts a tmux-backed session. Headless runs without a laptop terminal window; visible opens a terminal attached to the same session. /new tmux <target> attaches an existing tmux target.", Category: "sessions", Examples: []string{"/new --headless shell", "/new --visible codex", "/new tmux onibi", "/new tmux %1"}},
