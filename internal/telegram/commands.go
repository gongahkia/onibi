...
var commandSpecs = []CommandSpec{
	...
	{Name: "/menu", Short: "show dashboard", Detail: "Shows daemon state, default target, sessions, approvals, queue, snooze, secure mode, hook health, and inline buttons for common actions.", Category: "sessions"},
	...
	{Name: "/render", Args: "<id|name>", Short: "send terminal render", Detail: "Forces future previews for the target session to use a PNG rendered from the Onibi PTY/tmux buffer and sends the current preview immediately. This is not a Ghostty window screenshot.", Category: "controls"},
