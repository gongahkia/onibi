...
func (c Config) Validate() error {
	...
	case "lan", "tailscale", "telegram", "auto":
	default:
		return fmt.Errorf("transport.mode must be one of lan, tailscale, telegram, auto")
	}
...
func Keys(cfg Config, meta LoadMeta) []KeyInfo {
	...
	rows := []KeyInfo{
		...
		{"transport.mode", def.Transport.Mode, cfg.Transport.Mode, meta.Explicit["transport.mode"], "pairing transport: lan, tailscale, telegram, or auto"},
