...
func SupportedModeList() string {
	return "lan, lan-loopback, tailscale, wireguard, zerotier, cloudflare-quick, cloudflare-named, ngrok, telegram, matrix, slack, discord, pushover, ntfy, gotify, apns, auto"
}
