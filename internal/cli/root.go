...
func Root() *cobra.Command {
	...
	addGrouped(root, "maintain", configCmd(), storeCmd(), pushCmd(), unpairCmd(), installServiceCmd(), uninstallServiceCmd(), uninstallCmd(), updateCmd(), updateCheckCmd(), supportBundleCmd())
