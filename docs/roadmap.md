...
As of 2026-07-08, milestones #9-13 do not have GitHub due dates set. Expected dates are therefore shown as `TBD` instead of guessed.
...
| v0.5.0 | Full provider parity across Slack, Matrix, Discord, Telegram, Pushover, ntfy, and Gotify, plus PWA polish and coverage uplift. | TBD | [milestone #11](https://github.com/gongahkia/onibi/milestone/11) |
| v0.6.0 | Competitive parity: multi-session dashboard, diff viewer, image paste, voice input, WireGuard, ZeroTier, and new providers. | TBD | [milestone #12](https://github.com/gongahkia/onibi/milestone/12) |
...
v0.5.0 closes parity gaps around chat/notify providers, PWA behavior, and test coverage.
