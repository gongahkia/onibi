...
- OpenCode, Qoder, GitHub Copilot CLI, Goose, and Pi blocking hook/event integrations.
- Hermes ACP support, Gemini resume metadata, Aider history restore, and Cursor/OMP observe-only native hook support.
...
- Gemini, Aider, Cursor, and OMP do not yet provide full native blocking approval.
