...
| `operator` | explicitly scoped approve, deny, edit, and interrupt actions | invite, revoke, change roles, change tenant policy, kill a host, view unscoped sessions, or transfer ownership |
