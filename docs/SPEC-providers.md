...
account/pre-key device-session encrypt/decrypt wrappers, and encrypted local
crypto/session-state persistence. Encrypted rooms are not full Olm/Megolm E2EE
yet; room-level privacy remains E2.
