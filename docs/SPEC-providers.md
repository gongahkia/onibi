...
verification to-device message shapes, room encrypted/key request content
shapes, and encrypted local crypto/session-state persistence. Encrypted rooms
are not full Olm/Megolm E2EE yet; room-level privacy remains E2.
