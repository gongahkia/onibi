...
- Experimental notify-only approvals: Pushover and ntfy publish approval alerts without terminal text input after the same explicit opt-in.
...
- `internal/pushover` and `internal/ntfy` provide notify-only approval delivery.
