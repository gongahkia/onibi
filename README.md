...
1. See [`docs/operations.md`](docs/operations.md) for the live Vercel and Supabase resources, deploy procedure, Auth redirect configuration, and separate shutdown steps.
