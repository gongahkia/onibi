...
- Experimental notify-only approvals: Pushover publishes approval alerts without terminal text input after the same explicit opt-in.
...
- `internal/pushover` provides notify-only approval delivery.
