...
export async function importMcpConnector(input) {
...
export async function testMcpConnector(connector) {
...
export function createMcpAdapter(connector) {
...
async function listMcpTools(endpointUrl) {
...
async function callMcpTool(endpointUrl, toolName, payload) {
    const client = await connectMcp(endpointUrl);
    try {
...
async function connectMcp(endpointUrl) {
...
function assertAllowedHost(metadata, endpointUrl) {
