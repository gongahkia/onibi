export const gmailReceiptSearchInputFixture = {
    query: "from:(receipts OR orders) newer_than:30d",
    maxResults: 25
};
export const gmailReceiptPayloadFixture = {
    receipts: [
        {
...
export const sheetsReceiptRowsFixture = {
...
export const emailResultDeliveryFixture = {
...
export const receiptExtractionToSheetsFixture = {
    gmail: {
