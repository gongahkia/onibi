...
export type BuiltinSkillCapability = "gmail-receipts-read" | "sheets-rows-append" | "alert-urgency-classification" | "workflow-validation" | "approval-routing" | "adapter-dispatch" | "email-results-deliver" | "alert-push-dispatch";
