...
function adapterOperation(adapterId, operation, operationVersion = "1.0.0") {
    return {
        adapterId,
        operation,
        operationVersion
...
export const builtinSkills = [
    {
        ...
        runtimeTemplate,
        metaprompt: "Select this skill when the workflow needs Gmail receipt, order, invoice, or payment messages.",
    ...
    },
    {
        ...
        runtimeTemplate,
        metaprompt: "Select this skill when structured rows should be appended to a spreadsheet or sheet range.",
    ...
    },
    {
        ...
        runtimeTemplate,
        metaprompt: "Select this skill when a workflow needs primary result delivery, summaries, or completion notices by email.",
    ...
    },
    {
        ...
        adapterOperations: [],
        runtimeTemplate,
        metaprompt: "Select this skill when a support, incident, or escalation message needs urgency classification.",
    ...
    },
    {
        ...
        runtimeTemplate,
        metaprompt: "Select this skill only when a workflow explicitly asks for WhatsApp or Telegram time-sensitive push alerts.",
        validationRules: [
