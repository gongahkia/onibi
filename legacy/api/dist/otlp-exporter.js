...
export class DisabledApiOtlpExporter {
...
export class HttpJsonApiOtlpExporter {
    endpoint;
    headers;
    serviceName;
    serviceVersion;
...
export function createConfiguredApiOtlpExporter() {
    const endpoint = process.env.KELPCLAW_OTLP_TRACES_ENDPOINT ??
        process.env.OTEL_EXPORTER_OTLP_TRACES_ENDPOINT ??
        tracesEndpointFromBase(process.env.KELPCLAW_OTLP_ENDPOINT ?? process.env.OTEL_EXPORTER_OTLP_ENDPOINT);
    if (!endpoint) {
...
function tracesEndpointFromBase(value) {
    if (!value) {
        return undefined;
    }
...
//# sourceMappingURL=otlp-exporter.js.map