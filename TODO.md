...
(A) 2026-06-29 Implement tool onibi_list_sessions: input schema {include_remote: bool default false}; output [{id, agent, cwd, started_at, last_activity, pending_approvals_count, tokens_used, cost_usd, role_required, workspace}] +phaseQ4 @backend file:internal/mcpserver/tools.go id:T2431 accept:claude-mcp-call-returns-sessions
