...
(B) 2026-06-29 internal/store/cryptbox_test.go: round-trip, AAD-mismatch rejection, tampered-ciphertext rejection, empty-plaintext handling; -race -count=1 must be green +phaseQ0 @tests file:internal/store/cryptbox_test.go id:T2006 accept:race-tests-cover-tamper-cases
