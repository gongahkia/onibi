...
(B) 2026-06-29 Update /healthz to return {"e2e": <bool>, "key_verifier_hex": "<32hex>"} when E2E session active; phone can compute the expected verifier locally and warn on mismatch (defense vs. server lying about being E2E) +phaseQ0 @backend file:internal/web/server.go id:T2029 accept:health-payload-includes-verifier
