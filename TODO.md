...
(A) 2026-06-29 internal/anomaly/window.go: thread-safe sliding-window counters supporting both time-window (60s for rule 1) and turn-window (20 turns for rule 8); reused by rules 1 and 8 +phaseQ1 @backend file:internal/anomaly/window.go id:T2161 accept:race-safe-window-tests
