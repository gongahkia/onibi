...
(B) 2026-06-29 Verify WS app-level ping at 30s (TODO §3 rule 10) still fires after E2E framing wraps it; CF 100s idle must not disconnect; test by holding an idle WS open for 4 minutes +phaseQ0 @backend file:internal/web/ws_pty.go id:T2030 accept:no-cf-idle-disconnect-in-4min-test
