...
(A) 2026-06-29 Add internal/e2e/envelope.go with DeriveSessionKey(masterKey, sessionID []byte) []byte returning 32-byte AES-GCM key via HKDF-SHA256; reuse primitives from internal/envelope/envelope.go +phaseQ0 @backend file:internal/e2e/envelope.go id:T2022 accept:matches-webcrypto-test-vector
