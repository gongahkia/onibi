...
(A) 2026-06-29 Global workspace index: ~/.onibi/workspaces/<name>.toml (path, last_seen, ssh_key, default_transport); SQLite-backed table workspaces(name PK, path_enc, ssh_key_ref, last_seen) via Q0a +phaseQ2 @backend file:internal/workspace/store.go id:T2271 accept:workspace-roundtrips-disk
