...
(B) 2026-06-29 Add onibi store rekey CLI subcommand: generate fresh master key, re-Seal every encrypted column under it, rotate keychain entry; useful after a suspected compromise +phaseQ0 @backend file:internal/cli/store.go id:T2005 accept:rekey-produces-decryptable-db
