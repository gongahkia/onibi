...
(A) 2026-06-29 Schema migration 0007_encrypt_at_rest.sql: replace plaintext columns pairing_tokens.token, web_sessions.cookie, web_sessions.user_agent, audit_events.payload, plus chat-provider credential blobs in secrets table with <name>_enc BLOB columns; use existing migration mechanism in internal/store/migrations/ +phaseQ0 @backend file:internal/store/migrations/0007_encrypt_at_rest.sql id:T2002 accept:fresh-db-uses-only-_enc-columns
