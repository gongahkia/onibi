...
(B) 2026-06-29 Implement tool onibi_tail_logs: input {session_id, lines: int default 200}; output recent audit + PTY tail (scrubbed) +phaseQ4 @backend file:internal/mcpserver/tools.go id:T2436 accept:logs-returned
