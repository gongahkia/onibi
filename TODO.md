...
(B) 2026-06-29 frontend/src/anomaly.ts renders anomaly card: rule name, evidence in <pre>, Resume / Kill / Always-allow buttons; Always-allow appends entry to .onibi/anomaly-allowlist.toml +phaseQ1 @frontend file:frontend/src/anomaly.ts id:T2164 accept:anomaly-card-renders-on-iphone
