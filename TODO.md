...
(A) 2026-06-29 Implement tool onibi_list_pending_approvals: input {}; output pending approvals across all sessions (id, session_id, tool, args_scrubbed, risk_level) +phaseQ4 @backend file:internal/mcpserver/tools.go id:T2434 accept:list-matches-web-inbox
