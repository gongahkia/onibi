...
(A) 2026-06-29 Update internal/web/transport/cloudflare.go: when transport=cloudflare-quick, force E2E enabled; QR encodes https://<id>.trycloudflare.com/#k=<base64url(k)> with K never sent to relay +phaseQ0 @backend file:internal/web/transport/cloudflare.go id:T2027 accept:QR-includes-fragment
