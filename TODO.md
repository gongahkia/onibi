...
(A) 2026-06-29 Add diff2html@^3.4.56 to frontend/package.json; lazy import via dynamic import() inside approval.ts so non-Edit approvals do not pay the 25KB bundle cost +phaseQ1 @frontend file:frontend/package.json id:T2101 accept:dynamic-import-confirmed-in-build-output
