...
(A) 2026-06-29 Implement tool onibi_kill_session: input {session_id, force: bool default false}; calls daemon kill path; returns {killed: bool, signal: string}; refuses if the local socket user is not the same UID +phaseQ4 @backend file:internal/mcpserver/tools.go id:T2432 accept:kill-works-via-mcp
