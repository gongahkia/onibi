...
The requested subset size is 10. Two selected upstream rows have empty answer arrays and contribute 0 expected findings. The 14 non-empty expected answers are kept out of evidence and trace claims, then used only by the scorer:
