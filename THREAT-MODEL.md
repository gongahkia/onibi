...
- Chat providers such as Telegram, Slack, and Discord can see message plaintext unless the provider path has real end-to-end encryption. Do not route terminal secrets or approval payloads through plaintext chat transports.
