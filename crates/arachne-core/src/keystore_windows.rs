...
pub const WINDOWS_CREDENTIAL_SERVICE: &str = "com.github.gongahkia.arachne";
...
mod tests {
    ...
    fn stores_loads_and_deletes_namespaced_local_credentials() {
        ...
        assert_eq!(
            ...
            Some("com.github.gongahkia.arachne/identity_primary")
        );
        assert_eq!(
            keystore
                .credential_manager
        ...
        assert_eq!(WINDOWS_CREDENTIAL_SERVICE, "com.github.gongahkia.arachne");
        assert_eq!(
