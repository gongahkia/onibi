...
fn protocol_v1_vectors_match_public_encoders() {
    ...
    assert_vector!(
        ...
        WireEnvelope {
            ...
            kind: arachne_protocol::EnvelopeKind::EncryptedMessage,
            payload: vec![1, 2, 3],
        }
    ...
    assert_vector!(
        ...
        IdentityIdentifier::derive(
            &arachne_core::IdentityPublicKey::from_bytes([
...
fn qr_verification_payload() -> QrVerificationPayload {
    let first = arachne_core::IdentityPublicKey::from_bytes([
        0xd7, 0x5a, 0x98, 0x01, 0x82, 0xb1, 0x0a, 0xb7, 0xd5, 0x4b, 0xfe, 0xd3, 0xc9, 0x64, 0x07,
        0x3a, 0x0e, 0xe1, 0x72, 0xf3, 0xda, 0xa6, 0x23, 0x25, 0xaf, 0x02, 0x1a, 0x68, 0xf7, 0x07,
        0x51, 0x1a,
    ])
    .unwrap();
    let second = arachne_core::IdentityPublicKey::from_bytes([
