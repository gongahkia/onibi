...
mod windows_service_host {
    ...
    use arachne_relay::{RelayRuntimeConfig, RelayServer};
    use windows_service::{
    ...
    const SERVICE_NAME: &str = "ArachneRelay";
    const SERVICE_TYPE: ServiceType = ServiceType::OWN_PROCESS;
    const CONFIG_PATH: &str = r"C:\ProgramData\Arachne\relay.conf";
    const IDENTITY_PATH: &str = r"C:\ProgramData\Arachne\relay.identity";
