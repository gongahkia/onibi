...
pub const LAN_MDNS_SERVICE_TYPE: &str = "_arachne._udp.local.";
...
impl LanPeerDiscovery {
    ...
    pub fn advertise_for_transport(
        ...
        let instance = format!("arachne-{}", encode_hex(&identifier.as_bytes()[..8]));
...
pub enum LanPeerDiscoveryError {
    ...
    InvalidIdentity(#[source] arachne_core::IdentityPublicKeyError),
    #[error(
...
mod tests {
    ...
    use arachne_protocol::DirectProfileConfig;
    ...
    fn resolver_requires_a_valid_identity_and_endpoint() {
        ...
        assert_eq!(
            ...
            arachne_protocol::LocalMeshTransportKind::Lan
        );
        assert!(matches!(
            resolve_parts(
                None,
