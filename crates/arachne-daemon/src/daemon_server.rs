...
use arachne_daemon_api::v1::daemon_service_server::DaemonServiceServer;
...
mod tests {
    ...
    async fn daemon_grpc_schema_accepts_future_fields_and_rejects_invalid_boundaries() {
        const GET_STATUS_PATH: &str = "/arachne.daemon.v1.DaemonService/GetStatus";
        const UNKNOWN_STATUS_PATH: &str = "/arachne.daemon.v1.DaemonService/GetStatusV2";
