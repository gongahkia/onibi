...
const DIRECT_PEER_AUTH_LABEL: &[u8] = b"arachne/v1/direct-peer-authentication";
...
pub enum DirectTransportError {
    ...
    WireFrame(#[source] arachne_protocol::WireError),
    #[error("failed to derive direct peer-authentication connection binding")]
    ConnectionBinding,
    #[error("direct peer proof is invalid: {0}")]
    InvalidPeerProof(#[source] arachne_protocol::DirectPeerProofError),
