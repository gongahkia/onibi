...
impl CryptoDomain {
    ...
    pub fn context(self) -> &'static [u8] {
        let context: &[u8] = match self {
            ...
            Self::LocalLinkTranscript => b"yeokcham/v1/local-link-transcript",
            Self::LocalLinkProofBinding => b"yeokcham/v1/local-link-proof-binding",
            ...
            Self::AttachmentManifestEncryption => b"yeokcham/v1/attachment-manifest-encryption",
